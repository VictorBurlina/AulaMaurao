  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php else: ?>
          <a class="nav-link" href="recebe_numeros_soma.php">Home</a>
        <?php endif; ?>
        </li>
        <li class="nav-item">
        ...
        <?php if($pg_atual == 'subtracao'): ?>
          <a class="nav-link active" aria-current="page" href="recebe_numeros_subtracao.php">Subtracao</a>
        <?php else: ?>
          <a class="nav-link" href="recebe_numeros_subtracao.php">Subtracao</a>
        <?php endif; ?>
        <li class="nav-item">
        <?php if($pg_atual == 'multiplicacao'): ?>
          <a class="nav-link active" aria-current="page" href="recebe_numeros_multiplicacao.php">Multiplicação</a>
        <?php else: ?>
          <a class="nav-link" href="recebe_numeros_multiplicacao.php">Multiplicação</a>
        <?php endif; ?>
        <li class="nav-item">
        <?php if($pg_atual == 'divisao'): ?>
          <a class="nav-link active" aria-current="page" href="recebe_numeros_divisao.php">Divisão</a>
        <?php else: ?>
